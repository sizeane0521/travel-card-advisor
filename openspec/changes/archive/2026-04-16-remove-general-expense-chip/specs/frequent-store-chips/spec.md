...
The frequent store chips SHALL appear at the start of the chips area. When the search input is non-empty, the frequent store chips SHALL NOT be shown (filtered chips take over).
