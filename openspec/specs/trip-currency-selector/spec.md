# trip-currency-selector Specification

## Purpose

Provides a chip-based UI for selecting popular destination currencies when creating a trip, with automatic exchange rate fetching from an external API and manual override support.
...
<!-- @trace
source: trip-currency-auto-fetch
updated: 2026-04-14
code:
