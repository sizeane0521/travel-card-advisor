# expense-edit Specification

## Purpose

Allow users to edit existing expense records in the 明細 Tab, modifying amount, date, and card selection with recalculated rewards.
