# card-import-from-url Specification

## Purpose

Allows users to provide a bank promotion page URL and automatically extract credit card reward information from it using Claude API, pre-filling the card configuration form to reduce manual data entry.
