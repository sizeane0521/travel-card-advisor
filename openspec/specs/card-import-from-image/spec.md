# card-import-from-image Specification

## Purpose

Allows users to paste a screenshot or upload an image file in the card import panel, using AI Vision APIs (Claude multimodal or Gemini inline_data) to automatically extract credit card reward information, as an alternative when URL-based import is incomplete or unavailable.
