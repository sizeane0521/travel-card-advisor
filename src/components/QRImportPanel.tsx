  ...
  return (
    <div className="p-4 max-w-lg mx-auto">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h1 className="text-lg font-semibold" style={{ color: 'var(--color-text-base)' }}>掃碼匯入</h1>
      </div>
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="w-48 h-48 rounded"
                style={{ border: '2px solid var(--color-accent)', boxShadow: '0 0 20px rgba(0,185,181,0.3)' }} />
            </div>
          </div>
        ) : (
          <div className="p-8 text-center">
            <svg className="mx-auto mb-3 opacity-40" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" style={{ color: 'var(--color-secondary)' }} strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
            ...
            <p className="text-sm mb-4" style={{ color: 'var(--color-text-muted)' }}>點擊下方按鈕開啟相機掃描 QR Code</p>
      ...
      {error && (
        <div className="rounded-xl p-3 mb-4"
          ...
          <button onClick={startCamera}
            className="text-xs mt-1 underline" style={{ color: 'var(--color-danger)' }}>重試</button>
        </div>
      )}
